    ...
    <div v-else class="stats-content">
      ...
      <div class="stats-breakdown">
        <div class="stats-source">
          <a href="https://github.com/Fajar-RahmadJaya/KeyTik/releases" target="_blank" rel="noopener" class="source-link">
        ...
        <div class="stats-source">
          <a href="https://sourceforge.net/projects/keytik/" target="_blank" rel="noopener" class="source-link">
